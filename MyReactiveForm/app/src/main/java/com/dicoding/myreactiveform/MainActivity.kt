    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val passwordConfirmationStream = Observable.merge(
            ...
            RxTextView.textChanges(binding.edConfirmPassword)
                .map { password ->
                    password.toString() != binding.edPassword.text.toString()
                }
        )
        ...
        val invalidFieldsStream = Observable.combineLatest(
            ...
            Function3 { emailInvalid: Boolean, passwordInvalid: Boolean, passwordConfimationInvalid: Boolean ->
                !emailInvalid && !passwordInvalid && !passwordConfimationInvalid
            }
        )
